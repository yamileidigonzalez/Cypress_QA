describe('Transacciones OFF', () => {
    ...
    beforeEach('Entrar en la página', () => {
        ...
        cy.get('#submenu-transactions > :nth-child(3)')
    ...
    //Recorrer todas las opciones del filtro
    ...
    //Recorrer todas las opciones de Fecha y Hora
    ...
    // Recorrer todas las opciones de Datos del transaccion
    it('Recorrer todas las opciones de Datos del transaccion', () => {
        ...
        const opcionesFiltro_Datos_transaccion_Texto = [
            '#transactionDataFilter > .grid > :nth-child(2) > .p-inputwrapper > .p-inputnumber > .p-inputtext',
    ...
    //Recorrer todas las opciones de Datos de Tienda
